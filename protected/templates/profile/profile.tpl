    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    <p>
                        На Ваш email было отправлено письмо.<br />
                        Для подтверждения вашего аккаунта перейдите по ссылке, указанной в письме.<br />
                        Если Вы не видите письма, возможно, оно попало в папку "Спам" Вашего почтового ящика.
                    </p>
                </div>
            </div>
